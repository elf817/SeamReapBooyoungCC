...
export default function GalleryGrid({ images }: { images: string[] }) {
  ...
  return (
    <>
      ...
      {openIndex !== null && (
        <div
          className="fixed inset-0 z-[100] bg-deep-deep/95 flex items-center justify-center"
          onClick={close}
        >
          <button
            aria-label="닫기"
          ...
          <div
            className="relative w-[88vw] h-[78vh] sm:w-[76vw] sm:h-[82vh]"
            onClick={(e) => e.stopPropagation()}
          >
            <Image
              src={images[openIndex]}
              alt={`씨엠립 부영 컨트리클럽 갤러리 사진 ${openIndex + 1}`}
              fill
              sizes="90vw"
